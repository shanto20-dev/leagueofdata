...
var filterByPlayer = function filterByPlayer(playerName) {
  return d3.csv('https://raw.githubusercontent.com/shanto20-dev/leagueofdata/main/data/2021_Match_Data.csv').then(function (result) {
    var filteredResult;
